...
public class PropertyTestConfiguration {
    ...
    private static final String DEFAULT_SELENIUM_PORT = "org.openfaces.funcTests.selenium.default.port";
    ...
    private final int defaultSeleniumPort;
    ...
    public PropertyTestConfiguration(String fileName) {
        ...
        defaultSeleniumPort = Integer.parseInt(properties.getProperty(DEFAULT_SELENIUM_PORT));
    ...
    public int getDefaultSeleniumPort() {
        return defaultSeleniumPort;
    }
