...
import static org.openfaces.test.BaseSeleniumTest.BrowserType.*;
...
public class BaseSeleniumTest extends SeleniumTestCase {
    ...
    public static void init() {
        ...
        final SeleniumFactory seleniumFactory = new SeleniumFactory(
                properties.getDefaultHost(),
                properties.getDefaultSeleniumPort(),
                getBrowserPath(),
        ...
        runner.run(BaseSeleniumTest.class);
    }
    ...
    private static String getBrowserPath() {
        ...
        if (StringUtils.isNotBlank(defaultBrowser)) {
            ...
            } else if (defaultBrowser.equals(EXPLORER.name().toLowerCase())) {
    ...
    public static void makeScreenShoot(String methodName) {
        if (testResultLevel != null && StringUtils.isNotBlank(methodName) &&
            ...
            final String prefix = testResultLevel == FAIL
                    ? properties.getFailTestsFolder()
                    : properties.getCompleteTestsFolder();

            final String fileName = properties.getFailTestsFolder() + prefix + methodName +
                    "_screenShoot_" + dateFormat.format(new Date()) + ".jpg";
