 ...
 */
public class ShortConverterClientValidator extends AbstractClientValidator {
    ...
    public ShortConverterClientValidator() {
        addJavascriptLibrary(new ValidationJavascriptLibrary("shortConverterValidator.js", this.getClass()));
    }

    public String getJsValidatorName() {
        return "O$._ShortConverterValidator";
    }
