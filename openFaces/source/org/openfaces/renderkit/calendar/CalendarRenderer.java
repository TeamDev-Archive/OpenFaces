...
public class CalendarRenderer extends RendererBase {
    ...
    private void renderScriptsAndStyles(FacesContext context, UIComponent component) throws IOException {
        ...
        sb.initScript(context, calendar, "O$._initCalendar",
                ...
                StyleUtil.getCSSClass(context, component, calendar.getRolloverDayStyle(), StyleGroup.rolloverStyleGroup(), calendar.getRolloverDayClass(), DEFAULT_ROLLOVER_DAY_CLASS),
                StyleUtil.getCSSClass(context, component, calendar.getInactiveMonthDayStyle(),
                        StyleGroup.regularStyleGroup(3), calendar.getInactiveMonthDayClass(), DEFAULT_INACTIVE_MONTH_DAY_CLASS),
                StyleUtil.getCSSClass(context,
                        component, calendar.getRolloverInactiveMonthDayStyle(), StyleGroup.rolloverStyleGroup(3), calendar.getRolloverInactiveMonthDayClass(),
                        DEFAULT_ROLLOVER_INACTIVE_MONTH_DAY_CLASS),
                ...
                StyleUtil.getCSSClass(context, component, calendar.getRolloverSelectedDayStyle(), StyleGroup.selectedStyleGroup(1), calendar.getRolloverSelectedDayClass(), DEFAULT_ROLLOVER_SELECTED_DAY_CLASS),
                StyleUtil.getCSSClass(context, component, calendar.getTodayStyle(), StyleGroup.regularStyleGroup(5), calendar.getTodayClass(), DEFAULT_TODAY_CLASS),
                StyleUtil.getCSSClass(context, component, calendar.getRolloverTodayStyle(), StyleGroup.rolloverStyleGroup(5), calendar.getRolloverTodayClass(), DEFAULT_ROLLOVER_TODAY_CLASS),
                StyleUtil.getCSSClass(context, component, calendar.getWeekendDayStyle(), StyleGroup.regularStyleGroup(2), calendar.getWeekendDayClass(), DEFAULT_WEEKEND_DAY_CLASS),
                StyleUtil.getCSSClass(context, component, calendar.getRolloverWeekendDayStyle(), StyleGroup.rolloverStyleGroup(2), calendar.getRolloverWeekendDayClass(), DEFAULT_ROLLOVER_WEEKEND_DAY_CLASS),
                StyleUtil.getCSSClass(context, component, calendar.getDisabledDayStyle(), StyleGroup.rolloverStyleGroup(2), calendar.getDisabledDayClass(), DEFAULT_DISABLED_DAY_CLASS),
                StyleUtil.getCSSClass(context, component, calendar.getRolloverDisabledDayStyle(), StyleGroup.rolloverStyleGroup(), calendar.getRolloverDisabledDayClass(), DEFAULT_ROLLOVER_DISABLED_DAY_CLASS),
