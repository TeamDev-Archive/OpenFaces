...
O$.DateTimeFormat.prototype.parse = function(val, format, currentValue) {
...
O$.DateTimeFormat.prototype.format = function(dDate, format) {
  if (!dDate)
    return "";
...
O$.DateTimeFormat.prototype.unescapeHtml = function(val) {
  var re = /\&\#(\d+)\;/
  while (re.test(val)) {
...
O$.DateTimeFormat.prototype.getMonths = function() {
  return this.MONTHS;
}

O$.DateTimeFormat.prototype.getShortMonths = function () {
  return this.SHORT_MONTHS;
}

O$.DateTimeFormat.prototype.getWeekdays = function() {
  return this.WEEKDAYS;
}

O$.DateTimeFormat.prototype.getShortWeekdays = function() {
