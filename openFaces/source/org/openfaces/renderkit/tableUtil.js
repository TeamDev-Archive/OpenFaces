...
O$._getRowsInSection = function(table, tableSection) {
  var section = O$.getChildNodesWithNames(table, [tableSection])[0];
  var result = (section != null) ? O$.getChildNodesWithNames(section, ["tr"]) : [];
  return result;
};
