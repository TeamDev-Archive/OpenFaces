...
O$._initHintLabel = function(id, hintTimeout, hintClass, rolloverClass) {
  var label = O$(id);
  ...
  var labelInnerHtml = O$._hintLabel_getInnerHtml(label);
  label._mouseOverHandler = function (e) {
    ...
    if (labelInnerHtml == label._hint.innerHTML) { // idea is: do not show hint if hint text is the same as label text and label is not cutted
      if (!label._fullWidth) {
        label._fullWidth = O$._hintLabel_getElementWidth(label, true) * 1;
      }
      if (label._fullWidth <= label.offsetWidth && label._fullWidth <= label.parentNode.offsetWidth) return;
    }
    if (!label._hintFullWidth) {
      label._hintFullWidth = O$._hintLabel_getElementWidth(label._hint, false) * 1;
    }
    O$._hintLabel_prepareHint(label);
...
O$._hintLabel_getInnerHtml = function(label) {
  if (O$.isExplorer())
...
O$._hintLabel_getElementWidth = function(elt, extractScriptsFromInnerHtml) {
  ...
  stubElt.innerHTML = (extractScriptsFromInnerHtml) ? O$._hintLabel_getInnerHtml(elt) : elt.innerHTML;
...
O$._hintLabel_initHint = function(label) {
...
O$._hintLabel_prepareHint = function(label) {
