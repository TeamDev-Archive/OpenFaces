...
O$._initFoldingPanel = function(controlId,
                                expanded,
                                direction,
                                rolloverClass,
                                contentPreloaded,
  ...
  fp.setExpanded = function(expanded) {
    ...
    if (this._expanded && !this._contentLoaded) {
      if (this._useAjax) {
        O$.requestComponentPortions(this.id, ["content"], null, O$._foldingPanelAjaxResponseProcessor);
      } else {
...
O$._foldingPanelAjaxResponseProcessor = function(fp, portionName, portionHTML, portionScripts) {
