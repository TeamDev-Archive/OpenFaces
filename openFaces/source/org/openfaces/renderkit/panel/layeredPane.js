  ...
  _init: function(clientId, rolloverClass, containerClass, loadingMode, pageCount, selectedIndex) {
    ...
    O$.extend(tabbedPane, {
      ...
      _changeCurrentPageContainer: function(newPageContainer) {
        ...
        O$.LayeredPane._hideContainer(prevPageContainer);

        O$.LayeredPane._getContianerStyleElement(newPageContainer).className = tabbedPane._containerClass;
        O$.LayeredPane._showContainer(newPageContainer);
    ...
    function doSetSelectedIndex(absoluteIndex) {
    ...
    O$.LayeredPane._showContainer(currentPageContainer);
  },
