...
O$.sendAjaxRequest = function(render, args) {
  ...
  if (RichFaces && RichFaces.ajax && RichFaces.ajax.jsfRequest) {
...
O$.setAjaxMessageHTML = function(messageHTML, horizAlignment, vertAlignment, transparency, opacityTransitionPeriod,
