...
<head>
  ...
  <title>Tabbed Pane &#8212; OpenFaces Demo</title>
  ...
  <link rel="stylesheet" href="tabbedpane.css" type="text/css" media="screen,projection"/>
</head>
...
<div id="Page" class="clearfix">
  <f:view>
    <h:form id="form">
      ...
      <div id="Content">
        <!-- start content -->
        <%@ include file="TabbedPane_placementAndAlignment_core.xhtml"%>
        <!-- end content -->
      </div>
    </h:form>
  </f:view>
