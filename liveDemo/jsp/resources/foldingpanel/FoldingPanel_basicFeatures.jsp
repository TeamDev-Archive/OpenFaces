...
<head>
  ...
  <title>Folding Panel &#8212; OpenFaces Demo</title>
  ...
  <link rel="stylesheet" href="foldingpanel.css" type="text/css" media="screen,projection"/>
  <script src="foldingpanel.js" type="text/javascript"></script>
...
<div id="Page" class="clearfix">
  <f:view>
    <h:form id="form">
      ...
      <div id="Content">
        <!-- start content -->
        <%@ include file="FoldingPanel_basicFeatures_core.xhtml" %>
        <!-- end content -->
      </div>
    </h:form>
  </f:view>
