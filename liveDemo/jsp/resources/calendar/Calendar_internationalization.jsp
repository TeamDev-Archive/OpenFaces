...
<head>
  ...
  <title>Calendar &#8212; OpenFaces Demo</title>
  ...
  <link rel="stylesheet" href="calendar.css" type="text/css" media="screen,projection"/>
...
<div id="Page" class="clearfix">
  <f:view>
    <h:form id="form">
      ...
      <div id="Content">
        <!-- start content -->
        <%@ include file="Calendar_internationalization_core.xhtml" %>
        <!-- end content -->
      </div>
    </h:form>
  </f:view>
