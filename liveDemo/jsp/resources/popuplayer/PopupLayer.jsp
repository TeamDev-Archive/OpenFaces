...
<head>
  ...
  <title>Popup Layer &#8212; OpenFaces Demo</title>
  ...
  <link rel="stylesheet" href="popup.css" type="text/css" media="screen,projection"/>
  <script src="../utils/utility.js" type="text/javascript"></script>
  <script src="popuplayer.js" type="text/javascript"></script>
