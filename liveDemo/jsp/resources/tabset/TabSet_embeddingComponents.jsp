...
<head>
  ...
  <title>Tab Set &#8212; OpenFaces Demo</title>
  ...
  <link rel="stylesheet" href="tabset.css" type="text/css" media="screen,projection"/>
  <script type="text/javascript" src="../utils/utility.js"></script>
</head>
...
<div id="Page" class="clearfix">
  <f:view>
    <h:form id="form1">
      ...
      <div id="Content">
        <!-- start content -->
        <%@ include file="TabSet_embeddingComponents_core.xhtml"%>
        <!-- end content -->
      </div>
    </h:form>
  </f:view>
