...
<head>
  ...
  <title>Date Chooser &#8212; OpenFaces Demo</title>
  ...
  <link rel="stylesheet" href="datechooser.css" type="text/css" media="screen,projection"/>
...
<div id="Page" class="clearfix">
  <f:view>
    <h:form id="dcForm">
      ...
      <div id="Content">
        <!-- start content -->
        <%@ include file="DateChooser_core.xhtml" %>
        <!-- end content -->
      </div>
    </h:form>
  </f:view>
