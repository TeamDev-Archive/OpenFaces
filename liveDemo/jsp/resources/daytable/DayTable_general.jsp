on<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN"
...
<head>
  ...
  <title>Day Table &#8212; OpenFaces Demo</title>
  ...
  <script src="daytable.js" type="text/javascript"></script>
...
<div id="Page" class="clearfix">
  <f:view>
    <h:form id="form">
      ...
      <div id="Content">
        <!-- start content -->
        <%@ include file="DayTable_general_core.xhtml" %>
        <!-- end content -->
      </div>
    </h:form>
  </f:view>
