...
public class AverageTemp implements ChartModel, Externalizable, Serializable {
    ...
    private static class TupleComparator implements Comparator<Tuple> {
        public int compare(Tuple g1, Tuple g2) {
            int num1 = convertMonthToInteger((String) g1.getKey());
            int num2 = convertMonthToInteger((String) g2.getKey());
            if (num1 == num2)
                return 0;
