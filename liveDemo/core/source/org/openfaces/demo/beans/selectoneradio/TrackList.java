    ...
    public List<SelectItem> getEffectItems() {
        if (effectItems == null) {
            effectItems = Arrays.asList(
                    new SelectItem("Compressor"), //������������ ������
                    new SelectItem("Crystality"),
                    new SelectItem("True Bass"), //�������� ������ ������
                    new SelectItem("Band Pass"), //��������� ������
                    new SelectItem("Voice Removal"),
                    new SelectItem("Normalizer"), //���������� ���������
                    new SelectItem("Freeverb"), //����������
                    new SelectItem("Treble Enhancer"), //�������� ������� ������
                    new SelectItem("Downmix to mono"), //�������������� � ����
                    new SelectItem("Voice Emphasis"), //�������� ������
