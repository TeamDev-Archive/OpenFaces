...
public class TagCloudBean implements ActionListener, Serializable {
    ...
    private List<SelectItem> weightFormatList;
    public TagCloudBean() {
        initEntities();
        setMinFontSize(15);
        setMaxFontSize(50);
    ...
    private void initEntities() {
        ...
        coloredItemsList.add(new Item("DeskTop","","#",154,colors.getColorByText("DarkOrange")));
        coloredItemsList.add(new Item("LapTop","","#",132,colors.getColorByText("DarkOrange")));
        coloredItemsList.add(new Item("NetBook","","#",83,colors.getColorByText("DarkOrange")));
        coloredItemsList.add(new Item("iPod","","#",54,colors.getColorByText("DarkOrange")));
        coloredItemsList.add(new Item("Nexen","","#",25,colors.getColorByText("DarkOrange")));
        ...
        weightFormatList = new ArrayList<SelectItem>();
        weightFormatList.add(new SelectItem("(#0)"));
        weightFormatList.add(new SelectItem("[#0]"));
        weightFormatList.add(new SelectItem("<#0>"));
        weightFormatList.add(new SelectItem("-#0-"));
        weightFormatList.add(new SelectItem("#0"));
...
//    }
    ...
    public List<SelectItem> getWeightFormatList() {
        return weightFormatList;
    }

    public void setWeightFormatList(List<SelectItem> weightFormatList) {
        this.weightFormatList = weightFormatList;
    }
