 ...
 */
public class TestSelectionChangeListener implements SelectionChangeListener {

    public void processSelectionChange(SelectionChangeEvent event) {
        TabSetBean.testSelectionChangeListener = !TabSetBean.testSelectionChangeListener;
    }
}
