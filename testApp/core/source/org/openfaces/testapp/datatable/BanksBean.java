...
import org.openfaces.testapp.datatable.utils.FacesUtils;
...
public class BanksBean implements Serializable {
    ...
    private List<Bank> selectedBanks = new ArrayList<Bank>();
    ...
    public BanksBean() {
        ...
        try {
            InputStream resource = BanksBean.class.getResourceAsStream("Banks.txt");
