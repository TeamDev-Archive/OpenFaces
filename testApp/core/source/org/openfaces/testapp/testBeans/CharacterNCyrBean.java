 ...
 */
public class CharacterNCyrBean {
    ...
    public CharacterNCyrBean() {
        ...
        dropDownCollection.add(createFontColorItem("first row"));
        dropDownCollection.add(createFontColorItem("second row"));
        dropDownCollection.add(createFontColorItem("third row"));

        confirmationCancelButton = "Cancel";
        confirmationCaption = "Header";
